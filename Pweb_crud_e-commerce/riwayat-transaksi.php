...
<body>
	...
	<header>
		<div class="container">
			...
			<ul>
				...
				<li><a href="data-penjual.php">Data Penjual</a></li>
				<li><a href="riwayat-transaksi.php">Riwayat</a></li>
	...
	<div class="section">
		<div class="container">
			<h3>Riwayat Transaksi Pembelian</h3>
			<div class="box">
				<p><a href="tambah-produk.php">Tambah Barang</a></p>
